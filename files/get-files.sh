...
wget https://github.com/hexdump0815/vcvrack-dockerbuild-v1/releases/download/v1.1.1/vcvrack-v1-armv7l.tar.gz
wget https://github.com/hexdump0815/vcvrack-dockerbuild-v1/releases/download/v1.1.1/vcvrack-v1-aarch64.tar.gz
