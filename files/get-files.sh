...
wget https://github.com/hexdump0815/vcvrack-dockerbuild-v1/releases/download/v1.1.3.1/vcvrack.armv7l-v1.tar.gz
wget https://github.com/hexdump0815/vcvrack-dockerbuild-v1/releases/download/v1.1.3.1/vcvrack.aarch64-v1.tar.gz
